...
<section class="slp">
    <section class="food-hd">
        <div class="foodpic">
            <img src="upload/01.jpg" id="showimg">
            <ul class="smallpic">
                <li><img src="upload/tds.jpg" onmouseover="show(this)" onmouseout="hide()"></li>
                <li><img src="upload/01.jpg" onmouseover="show(this)" onmouseout="hide()"></li>
            </ul>
        </div>
        <div class="foodtext">
            ...
            <div class="price_a">
                <p class="price01">促销：￥<span>15.00</span></p>
                <p class="price02">价格：￥<s>18.00</s></p>
            </div>
            <div class="Freight">
                <span>配送费用：</span>
            ...
            <ul class="Tran_infor">
                <li>
                    <p class="Numerical">38</p>
                    <p>月销量</p>
                </li>
                <li class="line">
                    <p class="Numerical">49</p>
                    <p>累计评价</p>
                </li>
                <li>
                    <p class="Numerical">15</p>
                    <p>送幸福积分</p>
                </li>
            </ul>
