...
<section class="slp">
    <section class="food-hd">
        <div class="foodpic">
            <img src="upload/9.jpg" id="showimg">
            <ul class="smallpic">
                <li><img src="upload/9.jpg" onmouseover="show(this)" onmouseout="hide()"></li>
            </ul>
        </div>
        <div class="foodtext">
            ...
            <div class="price_a">
                <p class="price01">促销：￥<span>4.00</span></p>
                <p class="price02">价格：￥<s>5.00</s></p>
            </div>
            <div class="Freight">
                <span>配送费用：</span>
