...
<section class="slp">
    <section class="food-hd">
        ...
        <div class="foodtext">
            ...
            <div class="price_a">
                <p class="price01">促销：￥<span>7.00</span></p>
                ...
                <div class="menutab-wrap">
                    ...
                    <div class="menutab show">
                        <div class="cont_padding">
                            ...
                            <p>1.将鸡蛋打入碗中，快速搅匀至蛋黄打散，西红柿切块。</p>
                            <p>2. 锅热后倒入油，葱花爆香后倒入蛋液，鸡蛋炒散炒熟。</p>
                            <p>3.鸡蛋炒至金黄后，倒入西红柿块翻炒，直至西红柿炒软，汤汁溢出。</p>
                            <p>4. 加入盐和白糖，收汁后即可出锅。</p>
                        </div>
                    </div>
                    <!--case2-->
                    <div class="menutab">
