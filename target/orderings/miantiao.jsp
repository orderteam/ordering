...
<section class="slp">
    <section class="food-hd">
        <div class="foodpic">
            <img src="upload/10.jpg" id="showimg">
            <ul class="smallpic">
                <li><img src="upload/10.jpg" onmouseover="show(this)" onmouseout="hide()"></li>
            </ul>
        </div>
        <div class="foodtext">
            ...
            <div class="price_a">
                <p class="price01">促销：￥<span>8.00</span></p>
                <p class="price02">价格：￥<s>10.00</s></p>
            </div>
            <div class="Freight">
                <span>配送费用：</span>
            ...
            <ul class="Tran_infor">
                <li>
                    <p class="Numerical">43</p>
                    <p>月销量</p>
                </li>
                <li class="line">
                    <p class="Numerical">39</p>
                    <p>累计评价</p>
                </li>
                <li>
                ...
                <div class="menutab-wrap">
                    ...
                    <div class="menutab show">
                        <div class="cont_padding">
                            ...
                            <p>1.香菜、葱、姜均切末备用。</p>
                            <p>2. 牛肉移入炖锅，下牛骨汤，干辣椒，姜，豆瓣酱，花椒，红油，老抽开中火炖半个小时即可。</p>
                            <p>3.将面团加入拉面剂揉匀，拉成细条，放入开水锅中煮至浮起，用筷子捞出，装入盛有牛骨汤的碗中，再将香菜、姜、葱加入拉面中即可。</p>
                            <p>4. 拉面煮的时间不宜过长，以免煮烂面条，吃时无筋道、不滑爽。</p>
                        </div>
                    </div>
                    <!--case2-->
                    <div class="menutab">
