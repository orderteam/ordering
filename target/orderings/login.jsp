...
<body>
<!--标题  用户登录-->
<h1 style="color: #4EAC5C;" align="center">用
    &nbsp;&nbsp;&nbsp;户&nbsp;&nbsp;&nbsp;登&nbsp;&nbsp;&nbsp;录</h1>
...
<div id="from">
    ...
    <form id="loginForm" action="user?method=login"  method="post">
            ...
            <div class="form-group">
                <tr>
                    <td colspan="2">
                        ...
                        <div class="col-sm-6">
                            <input type="text" id="username" name="username" required="required" placeholder="请输入用户名">
