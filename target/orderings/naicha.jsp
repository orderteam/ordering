...
<section class="slp">
    <section class="food-hd">
        <div class="foodpic">
            <img src="upload/naicha.jpg" id="showimg">
            <ul class="smallpic">
                <li><img src="upload/naicha.jpg" onmouseover="show(this)" onmouseout="hide()"></li>
            </ul>
        </div>
        <div class="foodtext">
            ...
            <div class="price_a">
                <p class="price01">促销：￥<span>14.00</span></p>
            ...
            <ul class="Tran_infor">
                ...
                <li class="line">
                    <p class="Numerical">86</p>
                    <p>累计评价</p>
                </li>
                <li>
                    <p class="Numerical">14</p>
                    <p>送幸福积分</p>
                </li>
            </ul>
                ...
                <div class="menutab-wrap">
                    ...
                    <div class="menutab show">
                        <div class="cont_padding">
                            <img src="upload/naicha.jpg" width="400px">
