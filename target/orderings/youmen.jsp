...
<section class="slp">
    <section class="food-hd">
        <div class="foodpic">
            <img src="upload/03.jpg" id="showimg">
            <ul class="smallpic">
                <li><img src="upload/011.jpg" onmouseover="show(this)" onmouseout="hide()"></li>
                <li><img src="upload/03.jpg" onmouseover="show(this)" onmouseout="hide()"></li>
            </ul>
        </div>
        <div class="foodtext">
            ...
            <div class="price_a">
                <p class="price01">促销：￥<span>12.00</span></p>
                <p class="price02">价格：￥<s>15.00</s></p>
            </div>
            <div class="Freight">
                <span>配送费用：</span>
            ...
            <ul class="Tran_infor">
                <li>
                    <p class="Numerical">33</p>
                    <p>月销量</p>
                </li>
                <li class="line">
                    <p class="Numerical">48</p>
                    <p>累计评价</p>
                </li>
                <li>
                    <p class="Numerical">12</p>
                    <p>送幸福积分</p>
                </li>
            </ul>
                ...
                <div class="menutab-wrap">
                    ...
                    <div class="menutab show">
                        <div class="cont_padding">
                            ...
                            <p>1.将茄子切去柄、蒂洗净，切成大旆刀块，像菱角式样，放入盘中。</p>
                            <p>2.炒锅放旺火上，放入植物油，烧至五成热，倒入茄子焖炸，从温油炸到油沸，见茄子酥软，连油倒在漏勺中，控去油。</p>
                            <p>3.炒锅置于旺火上，撒入葱花、姜末，放入清水，倒入茄子，再加入料酒、酱油、白糖、精盐，翻动几下，烧开后，盖好炒锅，转为小火，焖煮约1分钟aaaaaddddd。</p>
                            <p>4.至汤汁稀少时移旺火上翻炒几秒种，加入味精和植物油15克，把炒锅晃动几下，待卤汁稠浓，油焖茄子即成。</p>
                        </div>
                    </div>
                    <!--case2-->
                    <div class="menutab">
